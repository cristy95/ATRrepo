...
begin
	...
	if v_stud_id isnull then
		...
		values (p_stud_id, p_college, p_course, p_nameFirst, p_nameMid, p_nameLast, 
				...
				p_special_project, p_thesis_title, p_status);
	else
 		update allinfo
...
create or replace function
 getstudinfoperid(in char(9), out char(9), out text, out text, out text, out text, out text, out text, out text, out int, out int, out int, out int, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text, out text)
